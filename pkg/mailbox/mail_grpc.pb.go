...
func (c *mailBoxClient) Send(ctx context.Context, in *Mail, opts ...grpc.CallOption) (*SendMailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mailbox.MailBox/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailBoxClient) ListServer(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ServerList, error) {
	out := new(ServerList)
	err := c.cc.Invoke(ctx, "/mailbox.MailBox/ListServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailBoxClient) Upload(ctx context.Context, opts ...grpc.CallOption) (MailBox_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &MailBox_ServiceDesc.Streams[0], "/mailbox.MailBox/Upload", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *mailBoxClient) Watch(ctx context.Context, in *Server, opts ...grpc.CallOption) (MailBox_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &MailBox_ServiceDesc.Streams[1], "/mailbox.MailBox/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func _MailBox_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mailbox.MailBox/Send",
	}
...
func _MailBox_ListServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mailbox.MailBox/ListServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
